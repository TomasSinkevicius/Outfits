...
namespace Outfits.Controllers
{
    public class RecommendationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OutfitPostId,Recommendation1,Recommendation2,Recommendation3")] Recommendation recommendation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OutfitPostId,Recommendation1,Recommendation2,Recommendation3")] Recommendation recommendation)
        {
